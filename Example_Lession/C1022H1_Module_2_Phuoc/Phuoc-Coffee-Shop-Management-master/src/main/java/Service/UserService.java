...
import view.AdminView.ManagerUserView;
...
public class UserService implements InterfaceUserService {
    final String Path = "/Users/user/Phuoc-Coffee-Shop-Management/data/userAccount.txt";
    ...
    public List<User> showUserView() {
        ...
        for (String lines : stringList){
            ...
            Date createdDate = DateUtil.convertStringToDate(line[8]);
    ...
    @Override
    public void removeUser(Long idUser,User user) {
    ...
    public User adminLogin(String username, String password) {
        List<User> users = showUserView();
        for (User user : users){
            if (user.getAccount().equals(username)&&user.getPassword().
                    equals(password)&&user.getRole().equals(Role.ADMIN)){
                return user;
            }
            ...
            if (u.getPassword().equals(passOld)) {
                ...
                do {
                    ...
                    if (passNew.equals(passNewCheck)) {
                        ...
                        updatePW(user);
                        System.out.println(PrintColor.GREEN+"Change password successfull!"+PrintColor.RESET);
                        break;
                    } else {
                        System.out.println(PrintColor.RED+"These password is not match together"+PrintColor.RESET);
