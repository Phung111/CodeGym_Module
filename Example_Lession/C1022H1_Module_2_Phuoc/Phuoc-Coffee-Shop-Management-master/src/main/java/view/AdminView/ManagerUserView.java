...
public class ManagerUserView {
    ...
    private Long inputId(User user) {
        Long id;
        boolean isRetry = false;
        do {
...
//
    public void showAllUser() {
        System.out.println("------------------------------------------------------------------------------------------------------------------------------------------------");
        System.out.printf("%13s %20s %20s %20s %15s %11s %25s",
                " ID",
                "NAME",
                "PHONE NUMBER",
                "EMAIL",
        ...
        for (User user : userService.showUserView()) {
            System.out.printf("%10s %20s %20s %20s %15s %10s %25s\n",
                    "【" + user.getID() + "】",
                    user.getFullname(),
                    user.getMobile(),
                    user.getEmail(),
                    user.getAddress(),
                    user.getRole(),
                    DateUtil.convertDateToString(user.getCreatedDate()));
        }
        System.out.println("------------------------------------------------------------------------------------------------------------------------------------------------");
    }
