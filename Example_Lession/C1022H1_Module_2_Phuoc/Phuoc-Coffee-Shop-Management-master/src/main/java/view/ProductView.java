...
public class ProductView {
    ...
    public void mainMenuView (User user){
    ...
    public void updateProductView(List<Product> products,User user) {
        Product product;
    ...
    public void sortProductView(List<Product> products,User user) {
        ...
        do {
            ...
            switch (choiceSortProduct) {
                ...
                case "2":
                    ...
                    break;
                case "3":
                    productService.sortByQuantity(products);
                    break;
                case "r":
                    mainMenuView(user);
                default:
    ...
    public void searchProductView(User user) {
        try {
            ...
            do {
                ...
                switch (choiceSearching){
                    ...
                    case "2":
                        ...
                        products = productService.searchProductByName(idproduct1.toUpperCase());
    ...
    public void removeProductView(List<Product> products, User user) {
